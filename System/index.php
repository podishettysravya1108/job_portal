...
<head>
	...
	<title>CarrerConnect Platform - Job Portal</title>
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<p>Finding your next job on CareerConnect Platform</p>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>careerConnect Jobs is a job portal, It makes the Job seekers life easier and Employeer finds the correct one.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : MRECW</p>
								<p>Email : <a href="mailto:CareerConnect.platform@gmail.com">CareerConnect.platform@gmail.com</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> CareerConnect Platform</p>
