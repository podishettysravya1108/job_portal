					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address> MRECW <br/> </address>
								</li>
								<li>
										<h5>Email</h5><a href="mailto:CareerConnect.platform@gmail.com">CareerConnect.platform@gmail.com</a>
								</li>
								<li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>CareerConnect platform Jobs is a job portal, It makes the job seekers life easier and Employeers find the correct one.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Address : MRECW</p>
								<p>Email : <a href="mailto:CareerConeent.platform@gmail.com">CareerConnect.platform@gmail.com</a></p>
